...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team for students interested in sports",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu"]
    },
    "Tennis Club": {
        "description": "Tennis practice and matches for all skill levels",
    ...
    "Music Band": {
        ...
        "max_participants": 25,
        "participants": ["james@mergington.edu", "lily@mergington.edu", "ryan@mergington.edu"]
    },
    "Debate Club": {
    ...
    "Science Olympiad": {
        ...
        "max_participants": 14,
        "participants": ["chris@mergington.edu", "nina@mergington.edu", "david@mergington.edu"]
    }
}
